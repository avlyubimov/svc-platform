...
PLACEMENTS = {
    ...
    "R23": Placement(22.0, 49.0),
    "C35": Placement(19.0, 49.0),
...
def board_graphics() -> list[str]:
    ...
    graphics.extend(
        [
            ...
            f'\t(gr_text "FOG_SW_IN FILTER" (at 20 52 0) (layer "F.SilkS") (uuid "{layout_uid("fog-label")}") (effects (font (size 0.8 0.8) (thickness 0.12))))',
        ]
    )
    return graphics
