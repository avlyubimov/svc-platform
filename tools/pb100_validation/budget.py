...
def validate_board_current_budget_design_calculation() -> None:
    ...
    for token in (
        ...
        "selected 80 V PG-HSOF-8-1 TOLL",
        "LFPAK56E",
        "4.032 W",
...
def validate_board_current_budget_value_freeze_checklist() -> None:
    ...
    for token in (
        ...
        "6mm2 / 10AWG",
        "IAUT300N08S5N012ATMA2",
        "selected IAUT300N08S5N012ATMA2 80 V PG-HSOF-8-1 TOLL",
        "4.032 W at 40 A",
        "IAUT300N08S5N014ATMA1 same-footprint TOLL",
        "BUK7J2R4-80MX 80 V LFPAK56E",
