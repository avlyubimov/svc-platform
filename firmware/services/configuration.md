...
that total-current, per-output current, and thermal telemetry calibration fields
remain in configuration rather than firmware constants, that current JSON rule
