...
- Infineon email response `IFX-260721-2228076` / `CRM0032570008656` supplied no
  ...
  variants and probe/safety boundaries. Its 36 remaining low-energy
  connections and `FAB-REVIEW` gate prohibit fabrication and energized use.
