...
| Production package | Draft | BOM sourcing snapshot was refreshed for selected manufacturer, distributor, JLCPCB componentSearch, and garage kit-candidate evidence on 2026-07-20; PCBWay assembly, zero/low-stock risks, final garage purchase lock, and schematic closeout evidence remain open |
