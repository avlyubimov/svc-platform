...
| Firmware safety core | Host-test ready | Output, battery, thermal, CAN, telemetry, events, logging, config, runtime boot, CAN-to-rule bridge, and rule paths covered |
