...
| PB-100 PCB/layout | EVT-LAYOUT-AUTHORIZED | There is 1 active blocker: `PBREL-007`; ADR-0020 makes it a production-only blocker. The controlled four-layer 150 mm x 90 mm partial import places all 28 currently footprint-bound schematic components plus eight holes without copper/clearance/courtyard collisions. It is explicitly not fabricable: 46 missing footprints, six U1 parity findings, 142 unconnected items, routing, power copper and the complete diagnostic population remain open. The aggregate authorization remains `EVT-LAYOUT-AUTHORIZED`. Q2-C100 is paused and optional. `EVT-FAB-AUTHORIZED` still requires the separate PB EVT-fab checklist, zero DRC/unconnected/parity findings, routed 40 A electrothermal and clamp-loop estimates, connector fit, DFM and laboratory safety evidence. Production remains `NO-GO` |
...
| LB-100 PCB/layout | EVT-LAYOUT-AUTHORIZED | There are 0 active blockers (0 active LBREL blockers). The controlled four-layer 100 mm x 70 mm board places all 100 schematic components plus eight holes with exact schematic parity apart from those holes and no copper/clearance/courtyard collision. Routing of 384 connections, planes, BLE keepout, dual-input connector/protection review, SI/safety review and footprint/silkscreen cleanup remain open; manufacturing outputs remain blocked |
...
| FB-100 PCB/layout | EVT-LAYOUT-AUTHORIZED | There are 0 active blockers (0 active FBREL blockers). The controlled 80 mm x 35 mm board contains all 44 frozen schematic footprints plus four mounting holes and ten routed local indicator series nets; 93 connections, copper pours, stackup-derived USB impedance, optional FOG-button fit and final layout review remain open. No Gerber, drill, BOM/CPL, pick-place, manufacturing ZIP, or PCBA order exists |
