...
## 2026-07-22 — Record deterministic EVT routing milestones

Decision: preserve autorouter-assisted copper only through reviewable CSV route
manifests regenerated by CI. FB-100 records all connectivity; LB-100 records a
first four-layer signal iteration; the partial PB-100 import permits only nets
prefixed `CAN1_`. Provisional PB power routing is explicitly rejected until the
46 missing footprint bindings and schematic parity findings close.

Result: FB-100 has 438 segments, 39 vias and zero unconnected/short/crossing/
clearance findings. LB-100 has 1,860 segments and 172 vias, reducing its routing
backlog from 384 to 55 without shorts, crossings or clearance findings. PB-100
routes nine CAN1 safety nets with 84 segments and eight vias, reducing the
partial-board backlog from 142 to 126; all 40 A copper remains open. USB tuning,
