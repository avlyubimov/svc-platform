...
kicad-cli pcb render hardware/power-board/PB-100/kicad/PB-100.kicad_pcb -o docs/assets/pcb-renders/PB-100-rev1-evt-top.png --side top --width 1800 --height 1080 --background opaque --quality high
kicad-cli pcb render hardware/power-board/PB-100/kicad/PB-100.kicad_pcb -o docs/assets/pcb-renders/PB-100-rev1-evt-bottom.png --side bottom --width 1800 --height 1080 --background opaque --quality high
kicad-cli pcb render hardware/power-board/PB-100/kicad/PB-100.kicad_pcb -o docs/assets/pcb-renders/PB-100-rev1-evt-isometric.png --side top --width 1800 --height 1200 --background opaque --quality high --perspective --floor --rotate 325,0,35
```
