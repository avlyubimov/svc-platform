...
| KiCad schematic review | Closed | `hardware/logic-board/LB-100/kicad/LB-100.kicad_sch`, `hardware/logic-board/LB-100/kicad/lib/LB100.kicad_sym`, `hardware/logic-board/LB-100/LB-100-schematic-review-closeout.md`, `tools/validate_board_schematics.py`, `docs/adr/ADR-0020-platform-evt-development-and-reference-loads.md` | Deterministic value-bearing capture exports 100 components and 199 electrical nets; PA8 `FOG_A_SW_IN` and PA9 `FOG_B_SW_IN` have independent ESD, selectable dry/12 V front ends, pull-up, RC, clamp and Schmitt-buffer chains; exact E73 powered-off isolation and all prior topology typed IC pins and symbol/footprint pads pass; ERC has no errors and only the reviewed cross-board USB_CC1/USB_CC2 isolated-label warnings |
