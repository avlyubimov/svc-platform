...
| USB service and ESD | Closed | `hardware/front-board/FB-100/FB-100-requirements.md`, `hardware/front-board/FB-100/FB-100-interface-signal-plan.csv`, `hardware/front-board/FB-100/FB-100-component-sourcing-precheck.csv`, `hardware/front-board/FB-100/FB-100-usb-service-closeout-precheck.csv`, `hardware/logic-board/LB-100/LB-100-fb-powered-off-corrective-review-2026-07-21.md` | USB-C service role, CC behavior, ESD protection, shield/chassis policy, no-back-power behavior, and the defined VBUS-absent low state are reviewed |
...
| KiCad schematic review | Closed | `hardware/front-board/FB-100/kicad/FB-100.kicad_sch`, `hardware/front-board/FB-100/kicad/lib/FB100.kicad_sym`, `hardware/front-board/FB-100/FB-100-schematic-review-closeout.md`, `tools/validate_board_schematics.py` | Deterministic value-bearing capture exports 44 components and 46 nets; exact R13/R14/C1 USB/UI topology typed IC pins and symbol/footprint pads pass with zero ERC findings |
