...
| TVS/load-dump protection | Conditional | `hardware/power-board/PB-100/PB-100-tvs-load-dump-margin-trace.csv`, `hardware/power-board/PB-100/PB-100-protection-validation.csv` | Clamp strategy is compatible with every downstream absolute maximum rating |
