...
| Board current budget | Conditional | `docs/adr/ADR-0008-pb-100-current-budget.md`, `hardware/power-board/PB-100/PB-100-board-current-budget-trace.csv`, `hardware/power-board/PB-100/PB-100-board-current-budget-freeze-review.csv`, `hardware/power-board/PB-100/PB-100-input-power-design-values.csv` | Input measurement, connector ratings, copper/thermal assumptions, and firmware-visible budget enforcement are all represented in schematic inputs |
