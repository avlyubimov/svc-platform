...
RXD returns only on `CAN1_RX_ROUTE`. The six active blockers are `PBREL-001`,
`PBREL-003`, `PBREL-004`, `PBREL-006`, `PBREL-007`, and `PBREL-011`. PCB
layout and manufacturing output remain blocked by their sourcing, harness,
bench, paired-stack, transient, SOA, thermal, and factory evidence.
