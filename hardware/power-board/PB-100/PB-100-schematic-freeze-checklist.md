...
| Current telemetry | Conditional | `docs/requirements/pb-100-requirements.md`, `hardware/power-board/PB-100/PB-100-current-telemetry.md`, `hardware/power-board/PB-100/PB-100-current-telemetry-trace.csv`, `hardware/power-board/PB-100/PB-100-current-telemetry-freeze-review.csv`, `hardware/power-board/PB-100/PB-100-current-telemetry-map.csv` | Per-output current and total input current measurement ranges are selected and mapped to LB-100 |
