...
| Low-current output stage | Conditional | `docs/adr/ADR-0011-pb-100-low-current-output-stage.md`, `hardware/power-board/PB-100/PB-100-preliminary-validation.md`, `hardware/power-board/PB-100/PB-100-low-current-output-baseline-trace.csv` | OUT5/OUT8/OUT9 external-controller implementation is validated without a direct 40 V smart-switch rail |
