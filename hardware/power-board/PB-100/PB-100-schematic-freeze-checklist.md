...
| Factory assembly readiness | Conditional | `docs/production/component-family-shortlist.md`, `hardware/power-board/PB-100/PB-100-assembly-readiness-trace.csv`, `hardware/power-board/PB-100/PB-100-factory-assembly-freeze-checklist.csv`, `hardware/power-board/PB-100/PB-100-factory-assembly-sourcing-precheck.csv`, `hardware/power-board/PB-100/PB-100-factory-assembly-closeout-precheck.csv`, `hardware/power-board/PB-100/PB-100-symbol-mpn-readiness.csv`, `hardware/power-board/PB-100/PB-100-fx18-paired-stack-closeout.md`, `production/bom/factory_bom_draft.csv`, `production/bom/pb100_assembly_sourcing_recheck.csv`, `production/bom/pb100_sourcing_evidence_snapshot.csv`, `hardware/power-board/PB-100/PB-100-schematic-review-closeout.md` | FX18 pre-layout mechanics are closed; close exact connector handling, BUK7S1R2-80M production status, LFPAK88 process, DNP inspection, and live JLCPCB/PCBWay sourcing before final release |
...
now captured, and the corrected FX18 mechanical input is closed for pre-layout
work. Actual transient/SOA/thermal evidence, CAN1 integration, factory sourcing,
and the other Conditional gates still block PCB layout.
...
RXD returns only on `CAN1_RX_ROUTE`. The five active blockers are `PBREL-001`,
`PBREL-004`, `PBREL-006`, `PBREL-007`, and `PBREL-011`. PCB layout and
manufacturing output remain blocked by their sourcing, harness, transient, SOA,
thermal, CAN1 integration, and factory evidence.
