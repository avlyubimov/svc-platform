...
10. Capture current and thermal telemetry sheets from the telemetry traces,
    freeze reviews, current and thermal value derivation prechecks, and value
    checklists.
